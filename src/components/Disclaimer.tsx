...
export default function Disclaimer() {
  return (
    <aside className="mt-8 p-4 border-l-4 border border-blue-700 bg-blue-50 text-blue-900 rounded shadow-sm hover:shadow-md transition-shadow dark:border-blue-400 dark:bg-blue-900/40 dark:text-blue-100 text-sm">
