        ...
        <section className="section bg-gray-800">
          <div className="container pt-20 pb-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch max-w-6xl mx-auto">
              <div className="card flex flex-col justify-center border border-accent/60 lg:col-span-7">
              ...
              <div className="relative rounded-lg overflow-hidden lg:col-span-5 shadow-lg">
                <Image 
