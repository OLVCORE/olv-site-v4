...
export default function SolucoesPage() {
  return (
    <MainLayout className="solucoes-page">
      {/* HERO DE AUTORIDADE */}
      <section className="container bg-[#141c2f] border border-[#2a3448] shadow-md rounded-xl p-8 mt-0 mb-[0.5cm] text-gray-200 hover:border-[#d4af37] hover:shadow-2xl transition-all duration-300">
      ...
      <div className="animate-gold-pulse bg-yellow-200/10 border-y border-yellow-400 px-4 py-1 md:py-[6px] text-sm md:text-base leading-snug text-gray-200 dark:text-gray-200 shadow-md container my-[0.5cm] home-alert">
