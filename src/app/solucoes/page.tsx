...
export default function SolucoesPage() {
  return (
    <MainLayout className="solucoes-page">
      ...
      <div className="animate-gold-pulse bg-yellow-200/10 border-y border-yellow-400 py-1 md:py-[6px] text-sm md:text-base leading-snug text-gray-200 dark:text-gray-200 shadow-md container my-[0.5cm] home-alert">
