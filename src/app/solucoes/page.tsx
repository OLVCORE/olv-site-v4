...
export default function SolucoesPage() {
  return (
    <MainLayout className="solucoes-page">
      {/* HERO DE AUTORIDADE */}
      <section className="max-w-7xl mx-auto px-4 bg-[#141c2f] border border-[#2a3448] shadow-md rounded-xl p-8 mt-[2.5cm] text-gray-200 hover:border-[#d4af37] hover:shadow-2xl transition-all duration-300">
