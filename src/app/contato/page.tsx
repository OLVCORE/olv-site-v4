...
export const metadata = {
  ...
  description: 'Entre em contato com a OLV Internacional. Nossa equipe estÃ¡ pronta para oferecer soluÃ§Ãµes personalizadas para sua empresa.',
    alternates: {
          ...
          <div className="container">
            <div className="bg-gray-800 dark:bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <h2 className="flex items-center gap-2 text-2xl md:text-3xl font-bold text-white mb-4">
                <span className="text-blue-400">ðŸ“±</span> Fale com a OLV Internacional
              </h2>
              <p className="text-lg text-gray-300 mb-6">
                Estamos aqui para conectar seu negÃ³cio ao mundo. Seja para tirar dÃºvidas, solicitar uma proposta 
                ou conhecer melhor nossas soluÃ§Ãµes, nossa equipe estÃ¡ pronta para atendÃª-lo. Preencha o formulÃ¡rio 
                abaixo ou utilize um de nossos canais de atendimento direto para iniciar uma conversa sobre como 
                podemos impulsionar suas operaÃ§Ãµes internacionais.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="consultoria">Consultoria EstratÃ©gica</option>
                  ...
                  <div className="flex items-start">
                    ...
                    <label htmlFor="termos" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                      Concordo com os <Link href="/politica" className="text-accent hover:underline">termos de privacidade</Link> e com o recebimento de comunicaÃ§Ãµes.
                    </label>
                  </div>
            ...
            <div className="w-full lg:w-1/3">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Segunda a Sexta: 08:00 Ã s 18:00<br />
              ...
              <div className="bg-primary text-on-primary rounded-lg shadow-lg p-6">
                ...
                <p className="mb-6">
                  Nossa equipe pode entrar em contato com vocÃª imediatamente para resolver seu problema.
                </p>
                <a 
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <div className="relative w-full h-80 bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center text-gray-400 dark:text-gray-500">
                  ...
                  <p className="text-center">Mapa serÃ¡ carregado aqui<br />Av. Paulista, 1471, Conjunto 1010<br />Bela Vista, SÃ£o Paulo - SP</p>
                </div>
              </div>
            </div>
          </div>
