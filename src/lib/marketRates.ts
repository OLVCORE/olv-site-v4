...
const DATA: MarketRate[] = [
  { modal: 'sea_fcl', origin: 'AR', destination: 'BR', unit: 'container_20', valueUSD: 1800, source: 'SeaRates', dt: '2025-06-24' },
  { modal: 'sea_fcl', origin: 'AR', destination: 'BR', unit: 'container_40', valueUSD: 2500, source: 'SeaRates', dt: '2025-06-24' },
  { modal: 'sea_lcl', origin: 'AR', destination: 'BR', unit: 'wm', valueUSD: 45, source: 'SeaRates', dt: '2025-06-24' },
  { modal: 'air', origin: 'AR', destination: 'BR', unit: 'kg', valueUSD: 6.5, source: 'TAC Freight', dt: '2025-06-24' },
  { modal: 'road_ftl', origin: 'AR', destination: 'BR', unit: 'truck', valueUSD: 3200, source: 'ANTT+Diesel', dt: '2025-06-24' },
  { modal: 'road_ltl', origin: 'AR', destination: 'BR', unit: 'kg', valueUSD: 1.4, source: 'ANTT+Diesel', dt: '2025-06-24' },
  { modal: 'rail', origin: 'AR', destination: 'BR', unit: 'kg', valueUSD: 0.9, source: 'Rumo Tariff', dt: '2025-06-24' },
